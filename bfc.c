...
int main(int argc, char **argv)
{
    if (argc <= 2)
    {
        printf("Usage: ./bfc [source filename] [output filename]\nCount of arguments can not be more than 2.\nIf you want to compile more than 2 BrainFuck source code, you have to ... FUCK! You seriously want to compile more than 1 file?! If yes - fuck you");
        exit(1);
    }
